#!/bin/bash
#
# Install script for PyCUDA, tested on NVIDIA Jetson TX2 running Ubuntu 18.04
#
# Taken from: https://github.com/jkjung-avt/tensorrt_demos/blob/master/ssd/install_pycuda.sh
# MIT License
#
